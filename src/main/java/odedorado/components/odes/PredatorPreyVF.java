...
import odedorado.components.functions.PredatorFunction;
import odedorado.components.functions.PreyFunction;
import odedorado.components.functions.initialcondition.InitialConditions;
import odedorado.components.visualizations.ScatterVisualization2D;
