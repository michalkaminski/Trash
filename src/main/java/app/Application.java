...
public class Application {
    public static void main(String[] args) throws InstantiationException, IllegalAccessException {
       // SpringApplication.run(Application.class, args);
        ...
        Layer hiddenLayer=new Layer(Neuron.class,2);
        ...
        dataRow1.setVariables(new ArrayList<Float>(Arrays.asList(0f, 0f)));
        dataRow1.setResults(new ArrayList<Float>(Arrays.asList(0f)));

        dataRow2.setVariables(new ArrayList<Float>(Arrays.asList(0f, 1f)));
        dataRow2.setResults(new ArrayList<Float>(Arrays.asList(0f)));

        dataRow3.setVariables(new ArrayList<Float>(Arrays.asList(1f, 0f)));
        dataRow3.setResults(new ArrayList<Float>(Arrays.asList(0f)));

        dataRow4.setVariables(new ArrayList<Float>(Arrays.asList(1f, 1f)));
        dataRow4.setResults(new ArrayList<Float>(Arrays.asList(1f)));
        ...
        backPropagation.train(network,dataSet,activationFunctions,costFunction);
